...
from sglang.srt.smc.mem_cache.allocator import copy_block_table
...
class SMCCoordinatorV2:
    ...
    def _collect_fast(self, slot_state: "ScheduleBatchSMC"):
        ...
        """
        from sglang.srt.smc.v2.kernels.fused_collect import batched_collect_fused
    ...
    def _dispatch_fast(self, plan, slot_state: "ScheduleBatchSMC") -> None:
        ...
        from sglang.srt.smc.v2.kernels.fused_resample_kv import batched_resample_kv
