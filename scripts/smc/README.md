...
python scripts/smc/smc_profile_engine.py --draft-model-path meta-llama/Llama-3.2-1B-Instruct
```

## Notes

- SMC now uses a single normal scheduler path; the old `smc_resampling_overlap` toggle has been removed.
