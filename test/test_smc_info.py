...
from sglang.srt.smc.v1.manager import (
    SMCFinishedParticleSnapshot,
    SMCGroupState,
    SMCManager,
)
from sglang.srt.smc.v1.info import SMCDraftInput, SMCVerifyInput
from sglang.srt.smc.common.utils import (
...
from sglang.srt.smc.v1.resampler import PendingResample, SMCResampler
...
class TestSMCReleaseHelpers(TestCase):
    @patch("sglang.srt.smc.common.utils.get_global_server_args")
...
class TestSMCResampler(TestCase):
    ...
    @patch("sglang.srt.smc.v1.resampler.systematic_resample")
